...
class MyTicketsState extends State<MyTicketsPage> {
  ...
  void initState() {
    ...
    myTicketBloc.add(GetMyTicketListData(token: token));
  }


  getTickets(dynamic ticketResponse) {
    var ticketList = ticketResponse['data']['usercurent-contest-tickets'];
    if (ticketList != "") {
