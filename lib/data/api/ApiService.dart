...
class ApiService {
  ...
  Future<dynamic> getUserLoginOtpVerify(
  ...
  ///resend otp
  Future<dynamic> getResendOtp(
    String userID,
  ) async {
    try {
      var url = Uri.parse(ApiConstants.baseUrl + ApiConstants.apiResendOtp);
  ...
  Future<dynamic> getContestDetailData(String token) async {
    try {
      var url =
          Uri.parse(ApiConstants.baseUrl + ApiConstants.apiCurrentContest);
      var request = http.Request('GET', url);
      request.body = '''''';
      //var request = http.StreamedRequest('GET', url);
  ...
  Future<dynamic> getPrivacyData(String token) async {
    try {
      var url =
          Uri.parse(ApiConstants.baseUrl + ApiConstants.apiTermsConditions);
      var request = http.Request('GET', url);
      request.body = '''''';
      //var request = http.StreamedRequest('GET', url);
  ...
  Future<dynamic> getMyPastTicketList(String token) async {
    try {
      var url = Uri.parse(ApiConstants.baseUrl + ApiConstants.apiMyPastTicket);
      var request = http.Request('GET', url);
      request.body = '''''';
      //var request = http.StreamedRequest('GET', url);
      request.headers['Authorization'] = 'Bearer $token';
  ...
  /// Redeem Coupon Tickets
  Future<dynamic> getRedeemCoupon(
    String couponcode,
    String price,
    String token,
  ) async {
    try {
      var url = Uri.parse(ApiConstants.baseUrl + ApiConstants.apiRedeemCoupon);

      var request = http.MultipartRequest('POST', url);
      request.headers['Authorization'] = 'Bearer $token';

      request.fields.addAll({
        ApiConstants.couponCode: couponcode,
  ...
  /// Buy Tickets
  Future<dynamic> getBuyTicketsMessages(
    String userId,
    String lotteryId,
    String ticketNumber,
  ...
  Future<dynamic> getSaveProfile(
    ...
    try {
      var url = Uri.parse(ApiConstants.baseUrl + ApiConstants.apiProfileUpdate);
  ...
  /// Get profile  Data*/
  Future<dynamic> getSocialLoginData(
      String email, String socialId, String name) async {
    try {
      var url = Uri.parse(ApiConstants.baseUrl + ApiConstants.apiSignupSocial);
  ...
  Future<dynamic> getForgotPasswordData(String email) async {
    try {
      var url =
          Uri.parse(ApiConstants.baseUrl + ApiConstants.apiForgetPassword);
  ...
  Future<dynamic> getChangePasswordData(
      String password, String passwordConfirmation, String token) async {
    try {
      var url =
          Uri.parse(ApiConstants.baseUrl + ApiConstants.apiChangePassword);
  ...
  Future<dynamic> getDeleteAccountData(String id, String token) async {
    try {
      var url = Uri.parse(ApiConstants.baseUrl + ApiConstants.apiDeleteAccount);

      var request = http.MultipartRequest('POST', url);
      request.headers['Authorization'] = 'Bearer $token';
      request.fields.addAll({ApiConstants.id: id});
